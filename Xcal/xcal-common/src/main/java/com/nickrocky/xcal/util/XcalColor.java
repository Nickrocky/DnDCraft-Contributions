...
public enum XcalColor {
    ...
    XcalColor(int colorHexCode){
        this.colorHexCode = colorHexCode;
    }

    /**
     * Gets the current XcalColor and converts it into a Kyori TextColor
    ...
    /**
     * Gets a Kyori Component with the XcalColor applied to a "random" string of words to see a text example
     * @return Random string of words with the desired XcalColor applied.
     * */
