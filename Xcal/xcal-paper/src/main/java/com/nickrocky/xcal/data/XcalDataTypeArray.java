...
public class XcalDataTypeArray<T extends ConfigurationSerializable> implements PersistentDataType<byte[], T[]> {

    private final Class<T> type;
    private final Class<T[]> types;

    public XcalDataTypeArray(Class<T> type, Class<T[]> types) {
        this.type = type;
        this.types = types;
    }
