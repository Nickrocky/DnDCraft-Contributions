...
public class AtlasDataTypeArray <T extends ConfigurationSerializable> implements PersistentDataType<byte[], T[]> {

    private final Class<T> type;
    private final Class<T[]> types;

    public AtlasDataTypeArray(Class<T> type, Class<T[]> types) {
        this.type = type;
        this.types = types;
    }
